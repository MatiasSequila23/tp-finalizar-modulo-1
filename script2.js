...
var imagenes=[
    "<img src='img/listado-lechelita-quesos-crema-entero.png' alt='imagen'>",
    "<img src='img/5954b954deaf2c03413be345.png' alt='imagen'>",
    "<img src='img/papas-38-gr.png' alt='imagen'>",
    "<img src='img/pringles-chica1-f6b1f55732d4070deb16445069474378-640-0.png' alt='imagen'>",
    "<img src='img/queso-holanda.png' alt='imagen'>",
    "<img src='img/sancor-manteca-200g-byb1-cc77d9f4db15061eba15913919669798-1024-1024.png' alt='imagen'>",
    "<img src='img/lactal-blanco-chico-byb1-4cb0032f01afa6635d16017364445003-1024-1024.png' alt='imagen'>",
    "<img src='img/214391-1534456298.png' alt='imagen'>"
];
var productos=[
    "Producto 1",
    "Producto 2",
...
function generar() {
    //Obtengo el select de colores
    var combo = document.getElementById("select-colores");
    // Obtengo el texto del index seleccionado del select
    ...
    divDetalleSelect.innerHTML += `<p> Los colores seleccionados a usar son: ${selected} </p>`;
     ...
     for (var i = 0; i < cantidadSeleccionada; i++) {
         ...
         if (producto !== null && producto !== undefined) {
             ...
             // Agrega imagen
             Card += `<figure> ${imagenes[i]} </figure>`;
             // Agregar nombre Producto
             Card += `<div class="contenido-card"><h3> ${productos[i]}</h3>`;
             // Agrega select pago
